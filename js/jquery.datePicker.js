	...
	$.extend(
		...
		{	
			...
			display : function(eleAlignTo)
			{
				...
				// Edit for Occasions WordPress Plugin
				/*$pop.append(
						$('<div style="text-align:center;border-bottom:solid 1px #328AB2;border-left:solid 1px #328AB2;border-right:solid 1px #328AB2;"><strong>' + OccasionsAjaxL10n.Time + ':</strong> <input name="ame_hour" id="ame_hour" type="text" size="1" maxlength="2" value="12" style="font-size:0.85em;padding:1px;" />:<input name="ame_minutes" id="ame_minutes" type="text" size="1" maxlength="2" value="00" style="font-size:0.85em;padding:1px;" /></div>')
				);*/
